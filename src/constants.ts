...
export const RDF_PREDICATE_FIRST = DataFactory.namedNode(PREFIX_RDF + 'first')
export const RDF_PREDICATE_REST = DataFactory.namedNode(PREFIX_RDF + 'rest')
export const RDF_OBJECT_NIL = DataFactory.namedNode(PREFIX_RDF + 'nil')
...
export const SHACL_PREDICATE_MESSAGE = DataFactory.namedNode(PREFIX_SHACL + 'message')
