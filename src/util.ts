...
export function findInstancesOf(clazz: NamedNode, template: ShaclPropertyTemplate): InputListEntry[] {
    ...
    if (template.in) {
        ...
        // Include configured resources and values currently generated by the form.
        const instances = template.config.store.getSubjects(RDF_PREDICATE_TYPE, clazz, null)
