...
import { ClassInstanceLoader, ClassInstanceResolver, Plugins } from './plugin'
...
export class Config {
    ...
    set classInstanceResolver(resolver: ClassInstanceResolver | undefined) {
        if (resolver) {
            this.classInstanceLoader = new ClassInstanceLoader(this, resolver)
        } else {
